...
# 基础路径
BASE_RESULTS_ROOT="/LD-FS/home/zhenhuachen/code/github/DeepMicroSeg/data/results1/RBD"
...
check_prerequisites() {
    ...
    # 检查测试数据路径
    local test_paths=(
        "/LD-FS/home/zhenhuachen/code/github/DeepMicroSeg/data/patch_0520/RBD/test/images"
        "/LD-FS/home/zhenhuachen/code/github/DeepMicroSeg/data/patch_0520/RBD/test/masks"
    )
...
check_checkpoint() {
    ...
    local checkpoint_path="${BASE_RESULTS_ROOT}/b_lm_sam_lora_${MODEL_TYPE}_number_${train_number}/checkpoints/sam_lora_RBD/best.pt"
...
run_single_test() {
    ...
    local log_file="${LOG_DIR}/test_RBD_number_${train_number}_$(date +%Y%m%d_%H%M%S).log"
